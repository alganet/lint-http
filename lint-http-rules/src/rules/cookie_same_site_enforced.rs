...
impl RuleMeta for CookieSameSiteEnforced {
...
static REGISTRATION: &dyn crate::rules::Rule = &CookieSameSiteEnforced;
...
mod tests {
    ...
    fn validate_rules_with_valid_config() {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "cookie_same_site_enforced");
