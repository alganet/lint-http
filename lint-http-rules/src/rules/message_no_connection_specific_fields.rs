...
impl ConnectionlessVersion {
    ...
    /// `None` and is `message_http_version_syntax_valid`'s finding rather than
    /// this rule's.
    ///
...
pub struct MessageNoConnectionSpecificFields;

impl MessageNoConnectionSpecificFields {
    ...
    fn check_te(
        ...
        // `message_te_header_constraints` owns this field's grammar and had
...
impl Rule for MessageNoConnectionSpecificFields {
    fn id(&self) -> &'static str {
        "message_no_connection_specific_fields"
    }
...
static REGISTRATION: &dyn crate::rules::Rule = &MessageNoConnectionSpecificFields;
...
mod tests {
    ...
    const RULE: MessageNoConnectionSpecificFields = MessageNoConnectionSpecificFields;
    ...
    /// selects no document. `message_http_version_syntax_valid` reports it.
    #[rstest]
    #[case("HTTP/2")]
    #[case("2.0")]
    #[case("")]
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "message_no_connection_specific_fields");
