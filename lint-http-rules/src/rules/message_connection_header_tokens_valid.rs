...
impl MessageConnectionHeaderTokensValid {
...
mod tests {
    ...
    fn scope_is_both() {
        ...
        assert_eq!(
            MessageConnectionHeaderTokensValid.scope(),
            crate::rules::RuleScope::Both
        );
    }
}
