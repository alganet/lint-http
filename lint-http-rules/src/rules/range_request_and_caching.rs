...
/// capture reconstructs that key. `cache_validation_chain` walks history
...
/// can be two representations out of date. `cache_validation_chain`
...
static REGISTRATION: &dyn crate::rules::Rule = &RangeRequestAndCaching;
