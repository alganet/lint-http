...
pub struct HostAndAuthorityConsistent;
...
static REGISTRATION: &dyn crate::rules::Rule = &HostAndAuthorityConsistent;
...
mod tests {
    ...
    fn check(version: &str, uri: &str, host_lines: &[&[u8]]) -> Option<Violation> {
        let rule = HostAndAuthorityConsistent;
    ...
    fn published_examples_agree_with_the_rule() {
        ...
        for example in HostAndAuthorityConsistent.examples() {
            let mut scheme = None;
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "host_and_authority_consistent");
