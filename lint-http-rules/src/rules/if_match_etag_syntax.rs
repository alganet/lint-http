...
impl RuleMeta for IfMatchEtagSyntax {
...
"#
    ...
    fn specifications(&self) -> &'static [crate::rules::SpecRef] {
        &[RFC_9110_8_8_3, RFC_9110_13_1_1, RFC_9110_5_6_1_1]
    }
        ...
        let finding = || -> Option<Violation> {
            ...
            if value.is_empty() {
                return Some(ctx.report_with(
                    &CONDITIONAL_EMPTY,
                    "If-Match header is empty or contains only whitespace".into(),
                ));
            }
...
static REGISTRATION: &dyn crate::rules::Rule = &IfMatchEtagSyntax;
...
mod tests {
    ...
    #[case(None, false)]
    fn if_match_cases(#[case] header: Option<&str>, #[case] expect_violation: bool) {
        let rule = IfMatchEtagSyntax;
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "if_match_etag_syntax");
    ...
    fn multiple_header_fields_merged_and_valid() -> anyhow::Result<()> {
        ...
        let mut tx = crate::test_helpers::make_test_transaction();
        let mut hm = HeaderMap::new();
        hm.append("if-match", HeaderValue::from_static("W/\"a\""));
    ...
    fn id_and_scope_are_expected() {
        let r = IfMatchEtagSyntax;
        assert_eq!(r.id(), "if_match_etag_syntax");
