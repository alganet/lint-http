...
pub struct MessageSingletonFieldsNotRepeated;
...
impl Rule for MessageSingletonFieldsNotRepeated {
...
static REGISTRATION: &dyn crate::rules::Rule = &MessageSingletonFieldsNotRepeated;
...
mod tests {
    ...
    fn run(tx: &crate::http_transaction::HttpTransaction) -> Option<String> {
        MessageSingletonFieldsNotRepeated
            .check_transaction(
                tx,
    ...
    fn scope_is_both() {
        assert_eq!(
            MessageSingletonFieldsNotRepeated.scope(),
            crate::rules::RuleScope::Both
        );
    }
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "message_singleton_fields_not_repeated");
