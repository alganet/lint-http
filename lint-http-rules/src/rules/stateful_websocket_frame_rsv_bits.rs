...
pub struct StatefulWebsocketFrameRsvBits;
...
impl StatefulWebsocketFrameRsvBits {
...
impl ProtocolRule for StatefulWebsocketFrameRsvBits {
    fn id(&self) -> &'static str {
        "stateful_websocket_frame_rsv_bits"
    }
...
static REGISTRATION: &dyn ProtocolRule = &StatefulWebsocketFrameRsvBits;
...
mod tests {
    ...
    const RULE: StatefulWebsocketFrameRsvBits = StatefulWebsocketFrameRsvBits;
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "stateful_websocket_frame_rsv_bits");
