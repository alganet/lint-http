...
pub struct ClientProxyConnectionDiscouraged;

impl Rule for ClientProxyConnectionDiscouraged {
    fn id(&self) -> &'static str {
        "client_proxy_connection_discouraged"
    }
    ...
    fn check_transaction(
        ...
        // `message_no_connection_specific_fields` reports with those versions'
...
static REGISTRATION: &dyn crate::rules::Rule = &ClientProxyConnectionDiscouraged;
...
mod tests {
    ...
    const RULE: ClientProxyConnectionDiscouraged = ClientProxyConnectionDiscouraged;
    ...
    /// `message_no_connection_specific_fields` carries that sentence. Two rules
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "client_proxy_connection_discouraged");
