...
impl MessageAllowHeaderMethodTokens {
...
impl Rule for MessageAllowHeaderMethodTokens {
    ...
    fn check_transaction(
        ...
        // `message_trailer_fields_validity` rather than field by field here, and
...
static REGISTRATION: &dyn crate::rules::Rule = &MessageAllowHeaderMethodTokens;
