...
static REGISTRATION: &dyn crate::rules::Rule = &MessageXForwardedConsistency;
...
mod tests {
    ...
    fn scope_is_the_request_direction() {
        assert_eq!(
            MessageXForwardedConsistency.scope(),
            crate::rules::RuleScope::Client
        );
    }
    ...
    fn published_examples_are_judged_the_way_they_are_labelled() {
        ...
        for ex in MessageXForwardedConsistency.examples() {
