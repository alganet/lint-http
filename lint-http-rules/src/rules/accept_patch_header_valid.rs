...
impl AcceptPatchHeaderValid {
    ...
    fn check_value(&self, value: &str, severity: crate::lint::Severity) -> Option<Violation> {
        ...
        for member in list_members_as_written(value) {
            ...
            // contradicts itself is `patch_method_content_type_match`'s
...
impl RuleMeta for AcceptPatchHeaderValid {
...
static REGISTRATION: &dyn crate::rules::Rule = &AcceptPatchHeaderValid;
...
mod tests {
    ...
    fn published_examples_agree_with_the_rule() {
        ...
        for example in AcceptPatchHeaderValid.examples() {
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "accept_patch_header_valid");
