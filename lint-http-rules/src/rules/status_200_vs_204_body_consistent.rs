...
impl Status200Vs204BodyConsistent {
...
static REGISTRATION: &dyn crate::rules::Rule = &Status200Vs204BodyConsistent;
...
mod tests {
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "status_200_vs_204_body_consistent");
    ...
    fn id_is_rule_name() {
        let rule = Status200Vs204BodyConsistent;
        assert_eq!(rule.id(), "status_200_vs_204_body_consistent");
    }
