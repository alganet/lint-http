...
pub struct ServerSecWebsocketVersionAdvertisement;

impl ServerSecWebsocketVersionAdvertisement {
...
impl Rule for ServerSecWebsocketVersionAdvertisement {
    fn id(&self) -> &'static str {
        "server_sec_websocket_version_advertisement"
    }
    ...
    fn check_transaction(
        ...
        // and `client_sec_websocket_headers_consistency` is the rule that says
...
static REGISTRATION: &dyn crate::rules::Rule = &ServerSecWebsocketVersionAdvertisement;
...
mod tests {
    ...
    fn exchange(requested: Option<&str>, status: u16, lines: &[&[u8]]) -> Option<Violation> {
        let rule = ServerSecWebsocketVersionAdvertisement;
    ...
    fn scope_is_server() {
        ...
        assert_eq!(
            ServerSecWebsocketVersionAdvertisement.scope(),
            crate::rules::RuleScope::Server
        );
    }
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "server_sec_websocket_version_advertisement");
