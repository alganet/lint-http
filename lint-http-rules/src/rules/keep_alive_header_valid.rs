...
impl Rule for KeepAliveHeaderValid {
    ...
    fn description(&self) -> &'static str {
         ...
         **What this rule does not decide.**\
         ...
         that own the version. `no_connection_specific_fields` reports both halves, each \
...
static REGISTRATION: &dyn crate::rules::Rule = &KeepAliveHeaderValid;
...
/// P2 gave it a home**, here and in `pragma_token_valid`,
...
mod tests {
    ...
    fn published_examples_are_judged_the_way_they_are_labelled() {
        ...
        for ex in KeepAliveHeaderValid.examples() {
