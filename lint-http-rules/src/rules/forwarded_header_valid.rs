...
use crate::helpers::list::{split_commas_respecting_quotes, split_semicolons_respecting_quotes};
...
static REGISTRATION: &dyn crate::rules::Rule = &ForwardedHeaderValid;
...
mod tests {
    ...
    fn published_examples_are_judged_the_way_they_are_labelled() {
        ...
        for ex in ForwardedHeaderValid.examples() {
