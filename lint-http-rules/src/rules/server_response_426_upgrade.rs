...
pub struct ServerResponse426Upgrade;

impl Rule for ServerResponse426Upgrade {
    fn id(&self) -> &'static str {
        "server_response_426_upgrade"
    }
    ...
    fn check_transaction(
        ...
        // `client_sec_websocket_headers_consistency` was reported for, one document
        // over. A 426 that does carry the field on those versions is reported by
        // `message_no_connection_specific_fields`, which is the sentence that
        // applies to it.
        //
        ...
        // `message_upgrade_header_syntax_valid`'s question.
        //
        ...
        let Some(value) = value else {
            ...
            // `message_trailer_fields_validity`'s finding, whose § 6.5.1 table
            // names this field.
            //
...
static REGISTRATION: &dyn crate::rules::Rule = &ServerResponse426Upgrade;
...
mod tests {
    ...
    const RULE: ServerResponse426Upgrade = ServerResponse426Upgrade;
    ...
    fn published_examples_agree_with_the_rule_and_with_the_neighbours() {
        ...
        let neighbours: [(&dyn crate::rules::Rule, &str); 2] = [
            (
                &crate::rules::message_connection_upgrade::MessageConnectionUpgrade,
                "message_connection_upgrade",
            ),
            (
                &crate::rules::message_upgrade_header_syntax_valid::MessageUpgradeHeaderSyntaxValid,
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "server_response_426_upgrade");
