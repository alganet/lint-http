...
static REGISTRATION: &dyn crate::rules::ProtocolRule = &Http3MaxPushId;
...
mod tests {
    ...
    fn make_config() -> crate::config::Config {
        crate::test_helpers::make_test_config_with_enabled_rules(&["http3_max_push_id"])
    }
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "http3_max_push_id");
