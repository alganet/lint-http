...
impl Rule for ServerLocationHeaderUriValid {
    ...
    fn check_transaction(
        ...
        // `server_redirect_status_and_location_validity`'s question, and the
        ...
        // `message_trailer_fields_validity`'s finding, and a `Location` arriving
        ...
        // for one is advice (`server_redirect_status_and_location_validity` says so
...
mod tests {
    ...
    fn judge(tx: &crate::http_transaction::HttpTransaction) -> Option<Violation> {
        ...
        ServerLocationHeaderUriValid.check_transaction(
            tx,
