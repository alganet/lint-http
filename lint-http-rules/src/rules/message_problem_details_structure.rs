...
impl Rule for MessageProblemDetailsStructure {
    ...
    fn check_transaction(
        ...
        // `message_content_type_well_formed` reports the duplication itself.
        ...
        // media type is `message_content_type_well_formed`'s.
