...
pub struct MessageSecWebsocketExtensionsSyntax;
...
impl MessageSecWebsocketExtensionsSyntax {
...
impl Rule for MessageSecWebsocketExtensionsSyntax {
    fn id(&self) -> &'static str {
        "message_sec_websocket_extensions_syntax"
    }
...
static REGISTRATION: &dyn crate::rules::Rule = &MessageSecWebsocketExtensionsSyntax;
...
mod tests {
    ...
    fn extensions(section: Section, lines: &[&[u8]]) -> Option<Violation> {
        let rule = MessageSecWebsocketExtensionsSyntax;
    ...
    fn scope_is_both() {
        ...
        assert_eq!(
            MessageSecWebsocketExtensionsSyntax.scope(),
            crate::rules::RuleScope::Both
        );
    }
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "message_sec_websocket_extensions_syntax");
