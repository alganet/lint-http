    ...
    fn specifications(&self) -> &'static [crate::rules::SpecRef] {
        &[
            ...
            crate::rules::SpecRef {
                ...
                note: "HTTP/3 — transfer codings are not defined and the field must not be used; message_no_connection_specific_fields reports it. The same section repeats the trailers half for interim responses",
            },
        ]
    }
