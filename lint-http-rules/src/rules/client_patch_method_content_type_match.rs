...
/// registry of them, which is why `semantic_patch_partial_update` can require
...
/// all. `server_patch_accept_patch_header` is the rule that judges the value.
///
...
impl Rule for ClientPatchMethodContentTypeMatch {
    ...
    fn check_transaction(
        ...
        // gives it. `client_request_method_token_valid` reports the spelling.
        //
        ...
        // `semantic_patch_partial_update`'s.
        //
...
static REGISTRATION: &dyn crate::rules::Rule = &ClientPatchMethodContentTypeMatch;
...
mod tests {
    ...
    /// nothing to compare; `semantic_patch_partial_update` is the rule that
    ...
    fn a_missing_content_type_belongs_to_the_neighbour() {
        ...
        let neighbour = crate::rules::semantic_patch_partial_update::SemanticPatchPartialUpdate;
        let cfg = crate::test_helpers::make_test_config_with_enabled_rules(&[neighbour.id()]);
        let mut tx = crate::test_helpers::make_test_transaction();
        tx.request.method = "PATCH".into();
