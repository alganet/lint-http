...
pub struct MessageContextFieldsDirection;
...
impl Rule for MessageContextFieldsDirection {
    fn id(&self) -> &'static str {
        "message_context_fields_direction"
    }
...
static REGISTRATION: &dyn crate::rules::Rule = &MessageContextFieldsDirection;
...
mod tests {
    ...
    fn shipped_severity_is_advisory() {
        ...
        let section = s
            .split("[rules.message_context_fields_direction]")
            .nth(1)
    ...
    fn scope_is_both() {
        assert_eq!(
            MessageContextFieldsDirection.scope(),
            crate::rules::RuleScope::Both
        );
    }
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "message_context_fields_direction");
