...
impl Rule for MessageMaxForwardsNumeric {
    ...
    fn check_transaction(
        ...
        // `message_trailer_fields_validity`'s finding; a `Max-Forwards` arriving
...
static REGISTRATION: &dyn crate::rules::Rule = &MessageMaxForwardsNumeric;
...
mod tests {
    ...
    fn scope_is_client() {
        ...
        assert_eq!(
            MessageMaxForwardsNumeric.scope(),
            crate::rules::RuleScope::Client
        );
    }
}
