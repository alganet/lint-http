...
static REGISTRATION: &dyn crate::rules::Rule = &AcceptRangesValuesValid;
...
mod tests {
    ...
    fn published_examples_are_judged_the_way_they_are_labelled() {
        ...
        for ex in AcceptRangesValuesValid.examples() {
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "accept_ranges_values_valid");
