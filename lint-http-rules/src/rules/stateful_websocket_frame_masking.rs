...
pub struct StatefulWebsocketFrameMasking;

impl ProtocolRule for StatefulWebsocketFrameMasking {
    fn id(&self) -> &'static str {
        "stateful_websocket_frame_masking"
    }
...
static REGISTRATION: &dyn ProtocolRule = &StatefulWebsocketFrameMasking;
...
mod tests {
    ...
    const RULE: StatefulWebsocketFrameMasking = StatefulWebsocketFrameMasking;
    ...
    fn validate_rules_with_valid_config() -> anyhow::Result<()> {
        ...
        crate::test_helpers::enable_rule(&mut cfg, "stateful_websocket_frame_masking");
