...
- [RFC 9114 §4.2](https://www.rfc-editor.org/rfc/rfc9114.html#section-4.2): The same for HTTP/3. `message_no_connection_specific_fields` is the rule that enforces the value restriction, on both versions
