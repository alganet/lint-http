...
- [RFC 9110 §10.2.4](https://www.rfc-editor.org/rfc/rfc9110.html#section-10.2.4): `Server` header field and `product` grammar: product = token ["/" product-version] *( RWS ( product / comment ) )
