...
- [RFC 9114 §4.1](https://www.rfc-editor.org/rfc/rfc9114.html#section-4.1): HTTP/3 — transfer codings are not defined and the field must not be used; message_http3_no_connection_header reports it. The same section repeats the trailers half for interim responses
