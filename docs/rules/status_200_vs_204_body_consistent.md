...
# Status 200 Vs 204 Body Consistent
...
- [RFC 9110 §9.3.7](https://www.rfc-editor.org/rfc/rfc9110.html#section-9.3.7): OPTIONS — "The response content, if any", so a successful OPTIONS carrying none is anticipated by the method's definition. It is reported like any other 200: the sentence describing the method is not the sentence this rule enforces
