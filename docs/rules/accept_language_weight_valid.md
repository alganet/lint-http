...
- [RFC 9110 §5.6.1.2](https://www.rfc-editor.org/rfc/rfc9110.html#section-5.6.1.2): Recipient Requirements for lists: the bracketing that makes an empty list element something a recipient may ignore. The sender's MUST NOT against generating one is §5.6.1.1's, and `language_tag_syntax` reports it on this field
