            ...
            let s = match hv.to_str() {
                ...
                Err(_) => {
                    return Some(Violation {
                        ...
                        message: "If-Match header contains non-UTF8 value".into(),
                    })
                }
            };
...
static REGISTRATION: &dyn crate::rules::Rule = &MessageIfMatchEtagSyntax;
...
mod tests {
    ...
    fn if_match_cases(#[case] header: Option<&str>, #[case] expect_violation: bool) {
        let rule = MessageIfMatchEtagSyntax;
    ...
    fn id_and_scope_are_expected() {
        let r = MessageIfMatchEtagSyntax;
        assert_eq!(r.id(), "message_if_match_etag_syntax");
